...
if (!function_exists("agregar_js")) {
    ...
    {
        wp_register_script('sistema_de_inscripcion_a_carreras_css', plugins_url('public/css/general.css', __FILE__), array(), '1', true); //los scripts se ponen en el footer (por eso el ultimo valor es true)
        wp_enqueue_style('sistema_de_inscripcion_a_carreras_css');
    }
}
